/* libmutter-9.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Meta", gir_namespace = "Meta", gir_version = "9", lower_case_cprefix = "meta_")]
namespace Meta {
	...
	public class Context : GLib.Object {
		[CCode (has_construct_function = false)]
		protected Context ();
		public void add_option_entries (GLib.OptionEntry entries, string translation_domain);
		public void add_option_group (GLib.OptionGroup group);
		public bool configure (int argc, string argv) throws GLib.Error;
...
[CCode (cheader_filename = "libmutter-9-custom.h", has_type_id = false)]
