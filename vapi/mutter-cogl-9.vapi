/* mutter-cogl-9.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Cogl", gir_namespace = "Cogl", gir_version = "9", lower_case_cprefix = "cogl_")]
namespace Cogl {
	...
	[CCode (cheader_filename = "cogl/cogl.h")]
	[Version (deprecated = true, deprecated_since = "1.18", replacement = "Texture.new_with_size", since = "0.8")]
