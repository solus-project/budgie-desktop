...
static void budgie_applet_info_get_property(GObject *object, guint id, GValue *value,
                                            GParamSpec *spec)
{
...
static void budgie_applet_info_set_property(GObject *object, guint id, const GValue *value,
                                            GParamSpec *spec)
{
        BudgieAppletInfo *self = BUDGIE_APPLET_INFO(object);
