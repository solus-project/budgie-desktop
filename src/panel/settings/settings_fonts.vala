...
public class FontPage : Budgie.SettingsPage {
    ...
    public FontPage()
    {
        ...
        this.add_row(new SettingsRow(fontbutton_title,
            _("Window Titles"),
        ...
        this.add_row(new SettingsRow(fontbutton_document,
            _("Documents"),
            _("Set the display font used by applications such as word editors")));
        group.add_widget(fontbutton_document);

        /* Interface */
        fontbutton_interface = new Gtk.FontButton();
        this.add_row(new SettingsRow(fontbutton_interface,
            _("Interface"),
        ...
        this.add_row(new SettingsRow(fontbutton_monospace,
            _("Monospace"),
